var app = new Vue({
  data: { text: document.querySelector("h1").textContent },
  methods: {
    // AJAX
    ...
    initMap: function() {
      L.mapbox.accessToken =
        "pk.eyJ1Ijoid2Vic29sdXRlLXRlY2giLCJhIjoiY2phd2tpOGRqMG5tcDM3bzEwdW55anE5bSJ9.sPGBdwhnc7uSpIir3JlSRA";
    ...
    determineWhatToDo: function(event) {},
    ...
    start: function() {
      ...
      recognition.addEventListener("result", event => {
        ...
        switch (whatIsSaid) {
          case "who is Raj":
            var sayIt = new SpeechSynthesisUtterance(
              "Raj is the one reason, that I am talking to you."
            );
            synthesis.speak(sayIt);
            break;
          case "who is pankaj":
            var sayIt = new SpeechSynthesisUtterance(
              "He developed my code so i can assist you."
            );
            synthesis.speak(sayIt);
            break;
          case "how are you":
          ...
          case "who are you":
            var sayIt = new SpeechSynthesisUtterance(
              "My name is Mike, and i am your new assistant."
            );
            synthesis.speak(sayIt);
            break;
          case "how many languages can you speak":
            var sayIt = new SpeechSynthesisUtterance(
              "Actually, i don't know yet. I would ask Raj or Pankaj and let you know."
            );
            synthesis.speak(sayIt);
            break;
